...
public class MainActivity extends AppCompatActivity {
    ...
    public void onclickaddBtn(View view) {
        ...
        Log.i("warehouse app", item.getName());
        Log.i("warehouse app", Double.toString(item.getCost()));
        Log.i("warehouse app", Integer.toString(item.getQuantity()));
        Log.i("warehouse app", item.getDescription());
        Log.i("warehouse app", Boolean.toString(item.isFreeze()));
        Log.i("warehouse app", Integer.toString(item.getId()));
    ...
    void addItem() {
        ...
        Item item = new Item(nameText.getText().toString(), Double.parseDouble(costText.getText().toString()),
                Integer.parseInt(qtyText.getText().toString()), freezeCond , descText.getText().toString());
        Log.i("warehouse app", item.toString());
        mItemViewModel.insert(item);
    }
